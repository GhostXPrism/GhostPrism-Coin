Contributing to GHOST PRISM Coin
============================

The GHOST PRISM Coin project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/ghost_prism-project/ghost_prism/blob/master/doc/translation_process.md)
...
The following applies to code changes to the GHOST PRISM Coin project, and is not to be
confused with overall GHOST_PRISM Network Protocol consensus changes.

Whether a pull request is merged into GHOST PRISM Coin rests with the project merge
...
Patches that change GHOST_PRISM consensus rules are considerably more involved than
...
Where a patchset proposes to change the GHOST_PRISM consensus, it must have been
...
The project leader is the release manager for each GHOST PRISM Coin release.
