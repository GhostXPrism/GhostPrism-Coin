...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/ghost_prism-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/ghost_prism-cli.cpp \
           src/ghost_prism-tx.cpp \
           src/ghost_prism.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/ghost_prism.qrc src/qt/ghost_prism_locale.qrc

TRANSLATIONS += src/qt/locale/ghost_prism_bg.ts \
                src/qt/locale/ghost_prism_de.ts \
                src/qt/locale/ghost_prism_en.ts \
                src/qt/locale/ghost_prism_es.ts \
                src/qt/locale/ghost_prism_fi.ts \
                src/qt/locale/ghost_prism_fr.ts \
                src/qt/locale/ghost_prism_it.ts \
                src/qt/locale/ghost_prism_ja.ts \
                src/qt/locale/ghost_prism_pl.ts \
                src/qt/locale/ghost_prism_pt.ts \
                src/qt/locale/ghost_prism_ru.ts \
                src/qt/locale/ghost_prism_sk.ts \
                src/qt/locale/ghost_prism_sv.ts \
                src/qt/locale/ghost_prism_vi.ts \
                src/qt/locale/ghost_prism_zh_CN.ts \
                src/qt/locale/ghost_prism_zh_TW.ts
