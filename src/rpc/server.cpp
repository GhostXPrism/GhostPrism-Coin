...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop GHOST_PRISM server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "GHOST_PRISM server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* GHOST_PRISM features */
        {"ghost_prism", "listmasternodes", &listmasternodes, true, true, false},
        {"ghost_prism", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ghost_prism", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ghost_prism", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"ghost_prism", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"ghost_prism", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"ghost_prism", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ghost_prism", "masternodedebug", &masternodedebug, true, true, false},
        {"ghost_prism", "startmasternode", &startmasternode, true, true, false},
        {"ghost_prism", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ghost_prism", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ghost_prism", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ghost_prism", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ghost_prism", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ghost_prism", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ghost_prism", "preparebudget", &preparebudget, true, true, false},
        {"ghost_prism", "submitbudget", &submitbudget, true, true, false},
        {"ghost_prism", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ghost_prism", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ghost_prism", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ghost_prism", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ghost_prism", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ghost_prism", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ghost_prism", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ghost_prism", "checkbudgets", &checkbudgets, true, true, false},
        {"ghost_prism", "mnsync", &mnsync, true, true, false},
        {"ghost_prism", "spork", &spork, true, true, false},
        {"ghost_prism", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> ghost_prism-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:2319/\n";
}
