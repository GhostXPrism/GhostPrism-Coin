...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("GHOST PRISM Coin ghost_prism-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ghost_prism-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ghost_prism transaction") + "\n" +
                               "  ghost_prism-tx [options] -create [commands]   " + _("Create hex-encoded ghost_prism transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ghost_prism transaction
