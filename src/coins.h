...
/** 
    ...
    ****Note - for GHOST_PRISM we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of ghost_prism coming in to a transaction
