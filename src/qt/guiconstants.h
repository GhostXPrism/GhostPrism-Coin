...
/* Ghost_Prism GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "GHOST_PRISM"
#define QAPP_ORG_DOMAIN "ghost_prism.org"
#define QAPP_APP_NAME_DEFAULT "GHOST_PRISM-Qt"
#define QAPP_APP_NAME_TESTNET "GHOST_PRISM-Qt-testnet"
