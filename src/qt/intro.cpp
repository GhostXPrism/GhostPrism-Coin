...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("GHOST PRISM Coin"),
     ...
     * override -datadir in the ghost_prism.conf file in the default data directory
     * (to be consistent with ghost_prismd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
