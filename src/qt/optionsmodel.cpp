...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::GHOST);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeGhost_PrismAmount"))
        SoftSetArg("-anonymizeghost_prismamount", settings.value("nAnonymizeGhost_PrismAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in ghost_prism.cpp during shotdown to also remove the window positions
