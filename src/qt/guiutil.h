...
/** Utility functions used by the GHOST_PRISM Qt UI.
 */
namespace GUIUtil
{
...
// Render GHOST_PRISM addresses in monospace font
...
// Parse "ghost_prism:" URI into recipient object, return true on successful parsing
