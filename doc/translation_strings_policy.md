...
This document provides guidelines for internationalization of the GHOST PRISM Coin software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to GHOST_PRISM network</numerusform>
            <numerusform>%n active connections to GHOST_PRISM network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `ghost_prism_en.ts` remains unchanged.
