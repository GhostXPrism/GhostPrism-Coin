...
The script [extract-osx-sdk.sh](https://github.com/ghost_prism-project/ghost_prism/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
ghost_prism/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/ghost_prism-project/ghost_prism/blob/master/doc/README_osx.md) for troubleshooting tips.
